...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('KVSTR')),
      body: Column(
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              // width: 500,
              // height: 600,
              width: MediaQuery.of(context).size.width * 1, // ширина карты
              height: MediaQuery.of(context).size.height * 1, // высота карты
              child: const YandexMap()
            )
          ),
          Container(
              height: MediaQuery.of(context).size.height * 0.2, // высота плашки под картой
